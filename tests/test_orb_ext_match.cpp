/**
 * @file test_orb_ext_match.cpp
 * @brief Test executable verifying ORB extraction and matching across frame pairs.
 *
...
int main(){
    ...
    // create ORB-detector
    cv::Ptr<cv::ORB> orb = cv::ORB::create(ORB_NUM_FEATURES, ORB_SCALE_FACTOR, ORB_N_LEVELS);
    ...
    {   
        ...
        cv::drawMatches(
            ...
            match_frames_orb(frames.at(i),frames.at(i+1)), // getting matches per-pair
            output);
